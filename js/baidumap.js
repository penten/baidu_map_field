        ...
        attach: function(context) {
            $('.map_container').each(function(i, el) {
                ...
                $.each(Drupal.settings[id], function(i, el) {
                    var point = new BMap.Point(parseFloat(el['lon']), parseFloat(el['lat']));
                    points.push(point);
                    ...
                    if(!editable) {
                        ...
                        if(Drupal.settings.baidu_map.label_style) {
                            label.setStyle(Drupal.settings.baidu_map.label_style);
                        }
                        pin.setLabel(label);
                        map.addOverlay(pin);
                        ...
                        if(Drupal.settings.baidu_map.pin_icon) {
                            var icon = new BMap.Icon(
                                ...
                                new BMap.Size(Drupal.settings.baidu_map.pin_icon_width, Drupal.settings.baidu_map.pin_icon_height));
                            pin.setIcon(icon);
                        }
                    } else {
